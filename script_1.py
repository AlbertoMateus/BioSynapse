# Create English version of JavaScript
js_english = '''// Space Biology AI Gap Analyzer - Main JavaScript (English Version)
...
# Save English JavaScript
with open('script_en.js', 'w', encoding='utf-8') as f:
    f.write(js_english)

print("✅ English JavaScript file created: script_en.js")